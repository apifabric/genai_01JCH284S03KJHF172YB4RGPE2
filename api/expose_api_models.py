...
def expose_models(api, method_decorators = []): 
    ...
    api.expose_object(database.models.CareService, method_decorators= method_decorators)
    ...
    api.expose_object(database.models.SupplyOrderDetail, method_decorators= method_decorators)
    api.expose_object(database.models.VendorProduct, method_decorators= method_decorators)
    return api
