...
@Component({
  selector: 'CareService-home',
  templateUrl: './CareService-home.component.html',
  styleUrls: ['./CareService-home.component.scss']
})
export class CareServiceHomeComponent implements AfterViewInit {
