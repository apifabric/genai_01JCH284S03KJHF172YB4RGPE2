...
@Component({
  selector: 'SupplyOrderDetail-home',
  templateUrl: './SupplyOrderDetail-home.component.html',
  styleUrls: ['./SupplyOrderDetail-home.component.scss']
})
export class SupplyOrderDetailHomeComponent implements AfterViewInit {
