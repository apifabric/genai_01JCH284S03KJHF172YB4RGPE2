...
@Component({
  selector: 'VendorProduct-home',
  templateUrl: './VendorProduct-home.component.html',
  styleUrls: ['./VendorProduct-home.component.scss']
})
export class VendorProductHomeComponent implements AfterViewInit {
